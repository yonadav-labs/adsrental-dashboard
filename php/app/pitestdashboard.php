...
<?php
	...
	{/*
		...
		echo "<td>";
		echo "  <a href='https://adsrental.com/app/admin/adsrental/lead/?q=$row[leadid]' target='_blank'>" . $row["first_name"] . " " . $row["last_name"] . "</a> ";
		echo "	(<a href='https://na40.salesforce.com/$row[leadid]' target='_blank'>on SalesSorce</a>)";
		echo "</td>";
