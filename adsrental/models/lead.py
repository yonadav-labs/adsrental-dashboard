...
class Lead(models.Model, FulltextSearchMixin):
    ...
    **How to test RaspberryPi device for lead**
    ...
    raspberry_pi = models.OneToOneField('adsrental.RaspberryPi', null=True, blank=True, default=None, help_text='Linked RaspberryPi device')
    bundler = models.ForeignKey('adsrental.Bundler', null=True, blank=True, default=None, help_text='New UTM source representation')
