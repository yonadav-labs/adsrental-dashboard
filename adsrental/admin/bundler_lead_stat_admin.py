...
class BundlerLeadStatsAdmin(admin.ModelAdmin):
    ...
    def in_progress_total_field(self, obj):
        return mark_safe('<a href="{url}?account_type=facebook_types&status=In-Progress&bundler={bundler_id}">{value}</a>'.format(
    ...
    def in_progress_offline_field(self, obj):
        return mark_safe('<a href="{url}?account_type=facebook_types&status=In-Progress&online=offline&bundler={bundler_id}">{value}</a>'.format(
            url=reverse('admin:adsrental_leadaccount_changelist'),
            bundler_id=obj.bundler_id,
    ...
    def in_progress_wrong_pw_field(self, obj):
        return mark_safe('<a href="{url}?account_type=facebook_types&status=In-Progress&wrong_password=yes&bundler={bundler_id}">{value}</a>'.format(
            url=reverse('admin:adsrental_leadaccount_changelist'),
            bundler_id=obj.bundler_id,
    ...
    def in_progress_security_checkpoint_field(self, obj):
        return mark_safe('<a href="{url}?account_type=facebook_types&status=In-Progress&security_checkpoint=yes&bundler={bundler_id}">{value}</a>'.format(
            url=reverse('admin:adsrental_leadaccount_changelist'),
            bundler_id=obj.bundler_id,
    ...
    def autobans_last_30_days_field(self, obj):
        return mark_safe('<a href="{url}?account_type=facebook_types&auto_ban=yes&banned_date=last_30_days&bundler={bundler_id}">{value}</a>'.format(
            url=reverse('admin:adsrental_leadaccount_changelist'),
            bundler_id=obj.bundler_id,
    ...
    def other_bans_last_30_days_field(self, obj):
        return mark_safe('<a href="{url}?account_type=facebook_types&auto_ban=no&banned_date=last_30_days&bundler={bundler_id}">{value}</a>'.format(
            url=reverse('admin:adsrental_leadaccount_changelist'),
            bundler_id=obj.bundler_id,
    ...
    def qualified_today_field(self, obj):
        return mark_safe('<a href="{url}?account_type=facebook_types&qualified_date=today&bundler={bundler_id}">{value}</a>'.format(
            url=reverse('admin:adsrental_leadaccount_changelist'),
            bundler_id=obj.bundler_id,
    ...
    def qualified_yesterday_field(self, obj):
        return mark_safe('<a href="{url}?account_type=facebook_types&qualified_date=yesterday&bundler={bundler_id}">{value}</a>'.format(
            url=reverse('admin:adsrental_leadaccount_changelist'),
            bundler_id=obj.bundler_id,
    ...
    def qualified_last_30_days_field(self, obj):
        return mark_safe('<a href="{url}?account_type=facebook_types&qualified_date=last_30_days&bundler={bundler_id}">{value}</a>'.format(
            url=reverse('admin:adsrental_leadaccount_changelist'),
            bundler_id=obj.bundler_id,
    ...
    def qualified_total_field(self, obj):
        return mark_safe('<a href="{url}?account_type=facebook_types&status=Qualified&bundler={bundler_id}">{value}</a>'.format(
            url=reverse('admin:adsrental_leadaccount_changelist'),
            bundler_id=obj.bundler_id,
    ...
    def delivered_not_connected_last_14_days_field(self, obj):
        return mark_safe('<a href="{url}?account_type=facebook_types&status=Qualified&in_progress_date=not_set&delivered_last_2_days=no&lead__delivery_date=last_14_days&bundler={bundler_id}">{value}</a>'.format(
            url=reverse('admin:adsrental_leadaccount_changelist'),
            bundler_id=obj.bundler_id,
    ...
    def delivered_connected_last_14_days(self, obj):
        return mark_safe('<a href="{url}?account_type=facebook_types&in_progress_date=any&delivered_last_2_days=no&lead__delivery_date=last_14_days&bundler={bundler_id}">{value}</a>'.format(
            url=reverse('admin:adsrental_leadaccount_changelist'),
            bundler_id=obj.bundler_id,
